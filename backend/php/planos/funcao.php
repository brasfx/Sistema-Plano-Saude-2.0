...
if (isset($_POST["acao"])) {
  switch ($_POST["acao"]) {
    ...
    case 'incluiMedico':
      if (isset($_POST["CRM"], $_POST["email"],  $_POST["telefone"], $_POST["senha"], $_POST["nome"], $_POST["CEP"], $_POST["endNum"], $_POST["especialidade"], $_POST["genero"])) {
        if (!empty($_POST["CRM"]) && !empty($_POST["email"]) &&  !empty($_POST["telefone"]) && !empty($_POST["senha"]) && !empty($_POST["nome"]) && !empty($_POST["CEP"]) && !empty($_POST["endNum"]) && !empty($_POST["especialidade"]) && !empty($_POST["genero"])) {
          incluiMedico($_POST["CRM"], $_POST["email"],  $_POST["telefone"], $_POST["senha"], $_POST["nome"], $_POST["CEP"], $_POST["endNum"], $_POST["especialidade"],$_POST["genero"]);
        }
      }
    ...
    case 'alteraMedico':
      if (isset($_POST["CRM"])) { //só preciso saber obrigatoriamente o CRM
        ...
        alteraMedico($_POST["CRM"], (!empty($_POST["email"]) ? $_POST["email"] : NULL), (!empty($_POST["senha"]) ? $_POST["senha"] : NULL), (!empty($_POST["telefone"]) ? $_POST["telefone"] : NULL), (!empty($_POST["nome"]) ? $_POST["nome"] : NULL), (!empty($_POST["CEP"]) ? $_POST["CEP"] : NULL), (!empty($_POST["endNum"]) ? $_POST["endNum"] : NULL), (!empty($_POST["especialidade"]) ? $_POST["especialidade"] : NULL),(!empty($_POST["genero"]) ? $_POST["genero"] : NULL));
      }
    ...
    case 'alteraPaciente':
      ...
      header("Location: ../paciente/editar_pac.php");
      break;
    case 'mostraPaciente':
      if (isset($_POST["CPF"])) { //só preciso saber obrigatoriamente o CPF
