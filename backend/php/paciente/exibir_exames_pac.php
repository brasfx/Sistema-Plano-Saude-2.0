...
$contador = filtraExamePaciente($_SESSION['CPF']);
?>
    ...
    <section class="center ">
      ...
      <div class="box">
        <div class="box-header">
          <h5 class="center">Meus exames</h5>
        </div>
        <div style="text-align:right;margin:30px 20px">
          <?php
          if($contador == null || $contador == 0){
            echo "<strong>Numero total de exames: 0</strong>";
          }else{
          echo "<strong>Numero total de exames: {$contador}</strong>";
          }
          ?>
          </div>
